...
public class TweetParseUtil {
    /**
     * FIXME burada https'i de gï¿½z ï¿½nï¿½nde tutmak lazï¿½m Birden fazla url bulma olayï¿½na da bak
     * 
     * @param tweetText
     * @return
     */
    ...
    public static String onlyText(String tweetText) {
        ...
        // stripping URLS
        while (!TextUtils.isEmpty(tweetText) && ((tweetText.contains("http:")) || (tweetText.contains("https:")))) {
    ...
    public static void main(String[] args) {
        String onlyText = TweetParseUtil.onlyText("deneme @uyeh @ýushs");
    }
