...
public class CentralityAnalysis {
    ...
    public static Map<CentralityTypes,ArrayList<Entry<User, BigDecimal>>> calculateCentralityOfUsers(String direnajId, String pass,
            String campaignID, int skip, int limit) throws Exception {
