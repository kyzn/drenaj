...
if  ( isset($_POST['input_query']) ) {
	...
	$con = connect();
	query($con, "INSERT INTO t_kw_query (query,freebase_id,freebase_type) VALUES ('$query', '$freebaseId', '$freebaseType')");
	closeCon($con);
}
?>
...
<body>
	...
	<form action="kw_search.php" name="query_form" id="query_form" method="post">
