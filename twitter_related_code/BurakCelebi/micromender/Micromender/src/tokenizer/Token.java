...
public class Token implements Comparable<Token> {
	...
	public boolean isRelatedWith (Search search) {
		...
		if (Label.URL==label) {
			...
			return handleIsRelatedWith(search); //TODO: url black list? http, htm, html, www, etc.
			
		} else {
			*/
			return search.getQueryTerms().contains(value) || search.getTopCooccuringTags().contains(value) || Util.asHashtag(search.getQuery()).substring(1).equals(value); //TODO: query terms
		// }
	}
	 ...
	 * @return
	 */
	public static boolean isRelatedWith (Collection<Token> tokens, Search search) {
	 ...
	 * @return
	 */
	public static Bag<Token> toTokens(String tokensSpaceSep, tokenizer.Label label) {
	 ...
	 * @return
	 */
	private static Bag<Token> toTokens(String[] tokenArr, tokenizer.Label label) {
