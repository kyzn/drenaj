...
#import drenajmongomanager

from tornado.gen import Return

def drenaj_simple_auth(f):
    '''
    ...
    @drenaj_simple_auth decorator. Looks up username and password from
    ...
    class descript(object):
         ...
         def make_bound(self, instance):
             ...
             def wrapper(*args, **kwargs):
                 ...
                 try:
                     # drenajmongomanager.check_auth(username, base64.urlsafe_b64encode( passwd_sha1.digest()))
                     pass
                 except Return, r:
                     db_user = r.value
                     if (len(db_user) == 1):
                         kwargs["drnjID"] = db_user[0]["drenajID"]
