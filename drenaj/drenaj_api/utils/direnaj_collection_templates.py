'''
    Contains definitions of document templates in drenaj collections
...
from utils.drnj_time import py_utc_time2drnj_time
...
def validate_document(document_template, document_data, fail=True):
    ...
    These templates are defined in :py:mod:`drenaj_collection_templates`
